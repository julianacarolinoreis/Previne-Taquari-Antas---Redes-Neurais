...
const renderMapBase=renderMap;renderMap=()=>{renderMapBase();const c=city(),levels=Object.keys(c.published).map(Number).sort((a,b)=>a-b);$("mapStatus").textContent=`contornos disponíveis: 0–${c.level_max} m · agregados: ${levels.join(", ")} m`};
