...
![Figura 1. Localização da estação Santa Tereza (86472600) e dos postos de montante com coordenada na telemetria SGB/ANA. Carreiro, 86298000 e 86430900 não figuram no mapa por ausência de coordenada. A área afluente ao 86472600 não foi recuperada no HidroWeb.](../pesquisas/figuras/figura1_postos_santa_tereza.png)

*Figura 1. Localização da estação Santa Tereza (86472600) e dos postos de montante com coordenada na telemetria SGB/ANA. Carreiro, 86298000 e 86430900 não figuram no mapa por ausência de coordenada. A área afluente ao 86472600 não foi recuperada no HidroWeb.*

**Quadro 2. Postos das combinações principais. Coordenadas da telemetria SGB/ANA do projeto. Distância geodésica até 86472600; não é tempo de viagem.**

| Código ANA/SGB | Nome | Latitude | Longitude | Distância geodésica até 86472600 |
| --- | --- | --- | --- | --- |
