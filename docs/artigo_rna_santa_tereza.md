...
**Tabela 1 – Desempenho do modelo de maior equilíbrio publicado em cada horizonte**

| Horizonte | Família | Equilíbrio | PERS (geral / validação / teste) | NS (teste) | MAE (cm) | E95 (cm) |
| --- | --- | --- | --- | --- | --- | --- |
